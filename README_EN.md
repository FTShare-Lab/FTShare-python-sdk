...
Official website: [FTShare](https://ftai.chat/ftshare). Explore the product and plans.
...
<img src="docs/assets/wechat-group-20260929.png" alt="FTShare WeChat community group" width="320" />
...
**The QR code is valid until September 29, 2026.** If it expires, please open an Issue and the maintainers will update the invitation.
